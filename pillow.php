...
// API integration 
$url = $_ENV['API_ROOT_DIR'] . 'product/getProductByCategory.php?category=pillow';
...
if (isset($response->status) && $response->status) {
    ...
    $products = []; // Handle case when no products are returned or API fails
}
...
<head>
    ...
    <title><?php echo isset($_ENV['APP_NAME']) ? $_ENV['APP_NAME'] : 'Default App Name'; ?> | Pillow</title>
</head>
    ...
    <div class="container mt-3 pt-3">
        <nav class="breadcrumb mt-3" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pillow</li>
            </ol>
        </nav>
        ...
        <div class="row" id="productList">
            <?php foreach ($products as $product): ?>
                <div class="col-md-6 col-lg-3 mb-4 product-item" data-price="<?php echo $product['price']; ?>" data-name="<?php echo $product['name']; ?>">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="card-title"><?php $product['is_available']; ?></p>    
            ...
            paginatedProducts.forEach(product => {
                ...
                productItem.innerHTML = `
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="card-title">${capitalizeFirstLetter(product.name)}</p>
